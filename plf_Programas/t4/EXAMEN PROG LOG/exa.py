...
try:
    #print("PREGUNTA 1 CUANTOS MACHOS y HEMBRAS EN EL ARCHIVO")#BIEN
    #macho_p1    =   df[df['sexo']   ==  'M']
    #hembras_p1  =   df[df['sexo']   ==  'F']
    #print(f'{macho_p1}, Total machos:   {len(macho_p1)}\n---------------------\n,{hembras_p1},  {len(hembras_p1)}')

    #print("PREGUNTA 2 ESPECIES REGISTRADAS DEL AÑO 2001")#BIEN
    #dosEsp  =   df[df['aï¿½o']  ==  2001]
    #print(f'{set(dosEsp)}')

    #print("PREGUNTA 4 REGISTRADOS EN EL SITIO 4")#BIEN
    ...
    #print("PREGUNTA 6 MACHOS REGISTRADOS EN 1999 QUE PESAN MAS DE 30")#BIEN
    #machos_p6   =   df[(df['sexo']   ==  'M')   &   (df['aï¿½o']    ==  1999)   &   (df['peso'] >   30)]
    #print(f'{machos_p6} \nTotal:  {len(machos_p6)}')

    #print("PREGUNTA 7 ESPECIE PB, QUE SON HEMBRAS, DEL SITIO 8 QUE PESAN ENTRE 25 Y 30")#BIEN
    #hembras_p7  =   df[(df['idespecie'] ==  'PB')    &   (df['sexo'] ==  'F')   &   (df['idsitio']  ==  8)  &   (df['peso'] >=25)   &   (df['peso'] <=  30)]
    #print(f'{hembras_p7} \nTotal:  {len(hembras_p7)}')


    #print("PREGUNTA 8 SABER CUAL ES EL PESO MEDIO")#BIEN
    #peso_p8 =   df[df['peso'].median()]
    #print(peso_p8)

    #print("PREGUNTA 9 ESPECIES REGISTRADAS EL DÍA 6 DE ABRIL")#BIEN
    #especies_p9 =   df[(df['dia']  ==  6)   &   (df['mes']   ==  4)]
    #print(especies_p9)

    #print("PREGUNTA 10 ESPECIES DS REGISTRADAS EN 1988 EN EL SITIO 22")
    listaesp    =   [x  for x   in  df[df['idespecie']]]
    print(set(listaesp))
    esp =   set(df['idespecie'] ==  '*')
